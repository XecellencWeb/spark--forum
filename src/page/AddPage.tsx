...
const AddPage = () => {
  return (
    <form className="max-w-4xl mt-8 mx-auto" action="">
       <label htmlFor="post">
       ...
       <button className="w-full rounded-md bg-blue-600 mt-8 hover:bg-blue-800 py-2 text-white text-center">Post</button>
    </form>
  )
}
